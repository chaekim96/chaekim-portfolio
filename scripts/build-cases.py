...
CASES = [
  dict(slug="lucent", emoji="🔦", title="Lucent",
    ...
    tldr="AI search visibility for small businesses. Lucent shows brands how they appear in ChatGPT, Perplexity, Gemini, and Claude answers, then helps them fix it.",
    role="Co-founder & CEO", team="Co-founder/CTO + a data science intern", timeline="October 2025 to present",
    cover=f'<a href="https://trylucent.ai" target="_blank" rel="noopener">{typecover("trylucent.ai ↗", "AI search visibility, live")}</a>', cover_class="",
    problem=p("Customers are starting to ask AI instead of Google. Small businesses have no way to see whether AI recommends them, and enterprise GEO tools are priced for enterprises."),
    did=ul(
      "Ran 21 customer discovery interviews through NSF I-Corps, which narrowed the ICP from \"everyone\" to digitally native SMBs and marketing agencies. Across the wider push, 100+ customer interviews across U.S. and APAC SMBs to test willingness to pay.",
      "Shaped positioning around \"the one-person marketing team\": GEO plus SEO execution, not just citation tracking. Tested 10 positioning strategies across 65 prospects to find the messaging that worked.",
      "Designed a cost-efficient tracking approach: statistical sampling, and re-running prompts only when model behavior or rankings change, instead of expensive daily prompt permutations.",
      "Led a paid pilot, delivering multi-site SEO and AI visibility audits and turning findings into an engineering action plan.",
      "Built the investor pitch: bottom-up SAM, phased GTM, and a 100+ question diligence prep bank.",
    ),
    results=results(("1", "first paying pilot"), ("5", "LOIs in 30 days"), ("+50%", "discovery response rate"), ("NSF", "I-Corps backing")) + "\n" + p("The pilot converted into an ongoing advisory relationship. " + C("any usage or revenue metric you're comfortable sharing")),
    differently=p("Lock the GTM motion earlier. Investors flagged it as the biggest gap, and they were right: positioning tests and pilots should have run in parallel from day one, not in sequence."),
  ...
  dict(slug="mobility", emoji="🦯", title="Mobility devices for older adults (stealth)",
    ...
    role="Co-founder, leading GTM, brand, outreach, and strategy (co-founder owns product and prototyping)", team="2 co-founders", timeline=C("timeline"),
    cover=typecover("Stealth", "No name, no mechanism, on purpose"), cover_class="",
    problem=p("Mobility aids are built like medical equipment. Users feel stigmatized, and common designs have real safety gaps."),
    did=ul(
      "Site visits to senior centers and assisted living facilities in the Berkeley area, plus 14+ conversations with operators, caregivers, and advisors.",
      "Researched why companies in this space stall (the person who pays, uses, and decides are often three different people; hardware margins erode; incumbents own distribution) and used it to shape strategy.",
      "Built the brand-as-moat thesis and a decision framework for the first product path.",
      "Designed an operating cadence for a team split across a 16-hour time difference.",
    ),
  ...
  dict(slug="ey", emoji="☁️", title="EY, AI & Data",
    ...
    tldr="Ran the operating system for a $200M+ cloud migration program at a Fortune 500 life sciences client: risk, OKRs, and the first executive QBR. It contributed to a $14M contract extension.",
    role="Senior Consultant, AI & Data Strategy (Staff Consultant, Data Analytics, 2021 to 2023)", team="EY Technology Consulting, 25+ client teams", timeline="August 2021 to July 2024",
    cover=typecover("$200M+", "cloud migration program · 25+ teams · 4,000 users"), cover_class="",
    problem=p("A Fortune 500 life sciences client was migrating its application portfolio to the cloud across 25+ teams. Risks surfaced late, executives got escalations instead of decisions, and there was no shared view of what was on track."),
    did=ul(
      "Established a program-wide risk and OKR system by implementing blocker and risk triage across 25+ teams, which enabled earlier resource reallocation and reduced executive escalations by 30%.",
      "Designed and launched the client's first QBR by synthesizing 50+ executive interviews into an operational roadmap, then standardized QBR governance across 5+ transformation programs.",
      "Orchestrated enterprise-wide adoption of a custom program management methodology by managing a 15-person team and designing and running tool training. 90% adoption among 4,000 target users.",
      "Prioritized applications for migration, modernization, or retirement across the client's IT portfolio with a value-capture framework. Secured SVP approval and identified $10M+ in savings over 3+ years.",
    ),
    results=results(("$14M", "contract extension secured"), ("−30%", "executive escalations"), ("90%", "adoption across 4,000 users"), ("$10M+", "savings identified over 3+ years")) + "\n" + p("Also at EY: logistics lead for a Fortune 500 consumer foods client (weekly KPI reporting and root-cause sessions; on-time delivery +20%, accuracy +10% YoY), data architect on an internal EY initiative, and an internal AI adoption campaign that drove 200%+ usage across 5 user segments. Earlier: price-volume-mix analysis for a Fortune 500 software client's FP&A team (recovered $5M in pricing and mix leakage) and re-architected Agile workflows for 25+ engineering teams (delivery performance +40% YoY)."),
    differently=p(C("what you'd do differently")),
  ...
  dict(slug="mirrorme", emoji="🃏", title="MirrorMe",
    ...
    tldr="An icebreaker card game for people who host. 150+ pre-launch purchase commitments at a $30 to 40 price point, with zero paid budget.",
    role="Co-founder, led GTM", team="2 co-founders", timeline="2024 " + C("exact months"),
    cover='<img src="/assets/img/projects/mirrorme/card-category.png" alt="MirrorMe category card: Openness to Experience, rated 1 to 5">', cover_class="case-cover--contain",
    problem=p("Hosts want their guests to actually talk. Most icebreaker games are either too shallow to matter or too intense for a room of near-strangers."),
    did=ul(
      "100+ user surveys and a 10-product competitive scan identified two high-intent segments: regular hosts, and the venues that host them.",
      "Designed the deck around the OCEAN personality model: category cards set a trait, question cards ask about someone at the table, and players rate 1 to 5.",
      "Skipped paid channels. Sold in person at card game cafes and social events in New York.",
      "Created and sold 50+ decks of the original game.",
    ),
    results=results(("150+", "pre-launch purchase commitments"), ("$30 to 40", "price point"), ("$0", "paid budget"), ("50+", "decks sold")) + "\n" + p("Insight: it sold itself in rooms where people already wanted to connect, so venue partnerships became the core channel."),
    differently=p(C("what you'd do differently")),
  ...
  dict(slug="tritooling", emoji="🏭", title="Tritooling",
    ...
    tldr="A year running operations at a family-owned precision manufacturer serving semiconductor, medical device, and industrial clients. Fewer defects, faster delivery, and a board-approved market entry case.",
    role="Director of Operations", team="Operations, logistics, and engineering teams", timeline="July 2024 to July 2025",
    cover=typecover("+15% / −30%", "on-time delivery / defects"), cover_class="",
    problem=p("Production bottlenecks were showing up as late deliveries and defects, and the company had no shared performance-management framework across operations, logistics, and engineering."),
    did=ul(
      "Redesigned workflows across operations, logistics, and engineering by establishing a performance-management framework to address production bottlenecks.",
      "Developed an ERP insourcing business case by assessing vendor costs and internal requirements, and presented recommendations to leadership.",
      "Built a market entry case for 5 APAC countries by benchmarking pricing and identifying scope expansion opportunities. " + C("the doc says 'Japan market entry'; the resume says 5 APAC countries. Which wording?"),
    ),
  ...
  dict(slug="events-app", emoji="📱", title="Events app",
    ...
    cover=typecover("End to end", "React Native · NestJS · Postgres · Stripe"), cover_class="",
    problem=p("Tutorials teach one layer at a time. I wanted to feel where a real product breaks: auth, payments, notifications, uploads, observability, all wired together."),
    did=ul(
  ...
  dict(slug="berkeley-builders", emoji="🛠️", title="Berkeley Builders Summer Program",
    ...
    cover=typecover("Builders", "summer accelerator at Haas"), cover_class="",
    problem=p("Founders at Haas lose the summer to unstructured time. The program gave them a cadence, peers, and accountability."),
