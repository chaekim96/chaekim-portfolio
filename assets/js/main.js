...
(function () {
  ...
  if (arcade) {
    ...
    const load = () => {
      ...
      ['/assets/js/arcade.js?v=11', '/assets/js/music.js?v=11'].forEach(src => { const sc = document.createElement('script'); sc.src = src; sc.defer = true; document.body.appendChild(sc); });
    };
